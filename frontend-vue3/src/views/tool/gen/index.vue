      ...
      <div class="table-container">
        <el-row :gutter="10" class="mb8">
          ...
          <right-toolbar
            ...
            @queryTable="getList"
            update="tool:gen:edit"
            @handleUpdate="handleEditTable"
            del="tool:gen:remove"
        ...
        <el-table v-loading="loading" class="table-content" border :data="tableList" @selection-change="handleSelectionChange">
