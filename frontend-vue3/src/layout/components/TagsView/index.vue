<template>
  <div id="tags-view-container" class="tags-view-container" :style="{ '--theme-color': theme }">
    <scroll-pane ref="scrollPaneRef" class="tags-view-wrapper" @scroll="handleScroll">
      ...
      >
        <svg-icon :icon-class="tag.meta.icon || (tag.meta && tag.meta.icon)" />
        {{ tag.title }}
...
.tags-view-container {
  ...
  .tags-view-wrapper {
    .tags-view-item {
      ...
      &:hover {
        background-color: color-mix(in srgb, var(--theme-color, #42b983) 20%, transparent);
      }
      &:last-of-type {
        margin-right: 15px;
      }
