...
const indexScript = (options) => {
  ...
  script += `
    ...
    import { list${BusinessName}, get${BusinessName}, del${BusinessName}, add${BusinessName}, update${BusinessName} } from "@/api/${businessName}";
...
const indexButtomTemplate = (moduleName, businessName) => {
  return `
           ...
           exp='${moduleName}:${businessName}:export'
